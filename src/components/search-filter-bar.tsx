    ...
    <div className="space-y-2 w-full">
      ...
      <div className="relative w-full">
        ...
        <Input
          ...
          className="pl-10 pr-9 h-9 w-full bg-background border-muted-foreground/20 focus-visible:ring-1 text-xs sm:text-sm"
        />
        {searchTerm && (
          <button
      ...
      {/* Sub-bar below search tab: Active filters on left, Controls on right */}
        ...
        <div className="flex items-center gap-2 shrink-0 ml-auto">
          ...
          {activeFilterCount > 0 && (
            <Button
              ...
              className="gap-1.5 text-xs text-muted-foreground hover:text-destructive h-8 px-2"
            >
              <X className="h-3.5 w-3.5" />
              <span>Clear all</span>
